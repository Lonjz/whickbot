...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.guild.member(message.author).hasPermission("ADMINISTRATOR"))  return message.channel.send(":no_entry: | You dont have `ADMINISTRATOR` Permission");

    
    
    let msg = await message.channel.send("Would you like to start the embed creator? (yes | no)");
