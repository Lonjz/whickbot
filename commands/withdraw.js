    ...
    Money.findOne({
        ...
        if (!money) {
            ...
            if(amt.toLowerCase() == "all") {
                ...
                return message.channel.send("Enter the withdraw amount as a positive integer!")
            } 
            if(amt <= 0) {
                return message.channel.send("Enter the withdraw amount as a positive integer!")
            }
            if (amt > money.bank) {
                return message.reply('You don\'t have that much coins in your bank!');
            }
            ...
            .setTitle("Succesfully withdrawn!")
            .setDescription(`**${amt}** coins has been added to your wallet!`)
            .setColor("RANDOM")
            .setTimestamp()
